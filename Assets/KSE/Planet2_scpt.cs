...
public class Planet2_scpt : MonoBehaviour
{
    private float rotateAngle = 0f;
    private float selfRotateAngle = 0f;
    public static float selfRotateSpeed = 1176f; // 지구의 자전 각속도; 임의로 설정
    private float rotateSpeed = selfRotateSpeed / 222.88f; // 지구의 공전 각속도
